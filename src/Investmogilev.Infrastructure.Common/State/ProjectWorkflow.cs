...
namespace Investmogilev.Infrastructure.Common.State
{
	...
	public class ProjectWorkflow
	{
		...
		public enum State
		{
			[EnumDescription("Проект редактируется")] Open,
			[EnumDescription("Проект находится на карте")] OnMap,
			[EnumDescription("Получен отклик")] InvestorApprove,
			[EnumDescription("Ожидает документы")] DocumentSending,
			[EnumDescription("Ожидает заполнение причастных лиц")] WaitInvolved,
			[EnumDescription("Ожидает ответов от причастных лиц")] InvolvedOrganizations,
			[EnumDescription("Ожидает созыва комиссии")] WaitComission,
			[EnumDescription("На комисии")] OnComission,
			[EnumDescription("Ожидает исправлений замечаний вынесеных на комиссии")] WaitComissionFixes,
			[EnumDescription("Ожидает исполком")] WaitIspolcom,
			[EnumDescription("На исполкоме")] OnIspolcom,
			[EnumDescription("Ожидает исправлений замечаний вынесенных на исполкоме")] WaitIspolcomFixes,
			[EnumDescription("Направлен в министерство экономики")] InMinEconomy,
			[EnumDescription("Разрабатывается план реализации")] PlanCreating,
			[EnumDescription("Реализация")] Realization,
			[EnumDescription("Проект завершен")] Done,
		}

		public enum Trigger
		{
			[EnumDescription("Отобразить на карте")] FillInformation,
			[EnumDescription("Разослать информацию")] UpdateInformation,
			[EnumDescription("Убрать с карты")] ReOpen,
			[EnumDescription("Откликнуться инвестору")] InvestorResponsed,
			[EnumDescription("Выбрать инвестора")] InvestorSelected,
			[EnumDescription("Обновить состояние документов")] DocumentUpdate,
			[EnumDescription("Заполнить причастных лиц")] FillInvolvedOrganization,
			[EnumDescription("Обновить состояние ответов причастных лиц")] InvolvedOrganizationUpdate,
			[EnumDescription("Направить на комиссию")] ToComission,
			[EnumDescription("На комиссию")] Comission,
			[EnumDescription("Уведомить о замечаниях вынесенных на комиссии")] ComissionFix,
			[EnumDescription("Обновить состояние замечаний вынесенных на комиссии")] ComissionFixUpdate,
			[EnumDescription("Направить на исполком")] ToIspolcom,
			[EnumDescription("На исполком")] Ispolcom,
			[EnumDescription("Уведомить о замечаниях вынесенных на исполкоме")] ToIspolcomFix,
			[EnumDescription("Обновить состояние замечаний вынесенных на исполкоме")] IspolcomFixUpdate,
			[EnumDescription("Направить в министерство экономики")] ToMinEconomy,
			[EnumDescription("Уведомить о одобрении министерства экономики")] MinEconomyResponsed,
			[EnumDescription("Обновить план реализации проекта")] UpdatePlan,
			[EnumDescription("Одобрить план реализации проекта")] ApprovePlan,
			[EnumDescription("Обновить состояние реализации проекта")] UpdateRealization,
			[EnumDescription("Отклонить реализацию проекта")] RejectDocument,
		}
